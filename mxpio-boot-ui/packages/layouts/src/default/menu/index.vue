<script lang="tsx">
  ...
  import { BasicMenu, SimpleMenu, ScrollContainer, AppLogo } from '@mxpio/components';
  ...
  import { isHttpUrl } from '@mxpio/utils/src/is';
  ...
  export default defineComponent({
    ...
    props: {
      ...
      theme: {
        type: [String] as PropType<ThemeEnum | null>,
      },
      splitType: {
