...
<script lang="ts" setup>
  ...
  import { useMultipleTabStore, useUserStore } from '@mxpio/stores';
  ...
  import { RouterEnum, PageEnum } from '@mxpio/enums';
  import { listenerRouteChange } from '@mxpio/logics/src/mitt/routeChange';

  import { useRouter } from 'vue-router';

  import { useMouse } from '@vueuse/core';
  // import { multipleTabHeight } from '@mxpio/settings/src/designSetting';
  ...
  // const { useMultipleTabStore, useUserStore } = useStore(['useMultipleTabStore', 'useUserStore']);
  ...
  const getWrapClass = computed(() => {
    return [
      prefixCls,
      {
        ...
        [`${prefixCls}--hover`]: unref(mouseY) < designSetting?.multipleTabHeight,
      },
    ];
  });
