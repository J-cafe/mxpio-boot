...
// import { DEFAULT_CACHE_TIME } from '@mxpio/settings';
import setting from '@mxpio/settings';
import type { LockInfo, ProjectConfig, TableSetting, UserInfo } from '@mxpio/types';
...
const localMemory = new Memory(encryptionSetting.DEFAULT_CACHE_TIME);
const sessionMemory = new Memory(encryptionSetting.DEFAULT_CACHE_TIME);
