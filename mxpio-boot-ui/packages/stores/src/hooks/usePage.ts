...
export function useGo(_router?: Router) {
  ...
  function go(
    ...
    if (isReplace) {
      ...
      // 当前 tab
      const currentIndex = tabStore.getTabList.findIndex((item: any) => item.name === currentName);
      // 当前 tab 数量
