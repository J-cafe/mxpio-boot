...
import { extendSlots } from '@mxpio/utils/src/helper/tsxHelper';
...
export default defineComponent({
  ...
  render() {
    ...
    return (
      // h-full  xys 20260323 取消h-full 样式，会导致页面渲染问题
      <div class={`flex flex-col bg-white ${this.getWrapperClass}`}>
        <VxeGrid
          ref="tableElRef"
