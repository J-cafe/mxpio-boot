...
<script lang="ts">
  ...
  import { RadioButtonGroup, ApiSelectPage } from '../../../../Form';
    ...
    setup() {
      ...
      watch(
        ...
        () => {
          ...
          formDesignComponents.customAttrs[formConfig.value.currentItem!.component] &&
            formDesignComponents.customAttrs[formConfig.value.currentItem!.component].forEach(
              async (item) => {
                if (item.component) {
