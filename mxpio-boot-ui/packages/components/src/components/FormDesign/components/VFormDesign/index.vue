  ...
  <Layout>
    ...
    >
      ...
      <CollapseContainer title="自定义控件">
        <CollapseItem
          :list="formDesignComponents.customComponents"
          @add-attrs="handleAddAttrs"
          :handleListPush="handleListPushDrag"
          @handle-list-push="handleListPush"
        />
...
<script lang="ts" setup>
  ...
  import { baseComponents, layoutComponents } from '../../core/formItemConfig';
  ...
  onMounted(() => {
    if (props.formConfigDef) {
      formConfig.value = cloneDeep(props.formConfigDef);
    }
  });
