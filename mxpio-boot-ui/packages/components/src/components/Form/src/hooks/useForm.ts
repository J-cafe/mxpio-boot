...
import type { DynamicProps } from '@mxpio/types/src/utils';
import { ref, onUnmounted, unref, nextTick, watch } from 'vue';
import { isProdMode } from '@mxpio/utils/src/env';
import { error } from '@mxpio/utils/src/log';
import { getDynamicProps } from '@mxpio/utils';
...
export function useForm(props?: Props): UseFormReturnType {
  ...
  function register(instance: FormActionType) {
    ...
    // 直接关联表单内部的响应式模型
    formDataRef.value = instance.getFormModel();
  ...
  return [register, methods, formDataRef];
}
