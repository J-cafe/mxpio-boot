<template>
  <div class="m-3">
    ...
    <TransferInNoticeModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './transferIn.data';
  import TransferInNoticeModal from './TransferInNoticeModal.vue';
  import ExecuteModal from './ExecuteModal.vue';
  import ExpandTable from './ExpandTable.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = 'TransferInNoticeList';
