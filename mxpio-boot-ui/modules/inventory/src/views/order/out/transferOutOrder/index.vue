<template>
  <div class="m-3">
    ...
    <TransferOutOrderModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './transferOutOrder.data';
  import TransferOutOrderModal from './TransferOutOrderModal.vue';
  import ExpandTable from './ExpandTable.vue';
  import ExecuteModal from './ExecuteModal.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = 'TransferOutOrderList';
