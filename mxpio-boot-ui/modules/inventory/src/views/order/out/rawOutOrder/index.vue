<template>
  <div class="m-3">
    ...
    <RawOutOrderModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './rawOutOrder.data';
  import RawOutOrderModal from './RawOutOrderModal.vue';
  import ExpandTable from './ExpandTable.vue';
  import ExecuteModal from './ExecuteModal.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = 'RawOutOrderList';
