<template>
  <div class="m-3">
    ...
    <RawInOrderModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './rawInOrder.data';
  import RawInOrderModal from './RawInOrderModal.vue';
  import ExpandTable from './ExpandTable.vue';
  import ExecuteModal from './ExecuteModal.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = 'RawInOrderList';
  ...
  const {
    ...
    module: 'erp',
    filters: {
      'woType@IN': '00,10,15,16,17,18,19,49,51,57,59,63,65,87,84',
    },
  });
