<template>
  <div class="m-3">
    ...
    <TransferInOrderModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './transferInOrder.data';
  import TransferInOrderModal from './TransferInOrderModal.vue';
  import ExpandTable from './ExpandTable.vue';
  import ExecuteModal from './ExecuteModal.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = ' TransferInOrderList';
