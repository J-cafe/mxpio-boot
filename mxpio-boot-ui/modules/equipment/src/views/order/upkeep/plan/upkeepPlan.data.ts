...
export const columns: VxeGridPropTypes.Columns = [
  ...
  { title: '工时', field: 'planHourRation', width: 100 },
...
export const targetColumns: VxeGridPropTypes.Columns = [
  ...
  { title: '上次保养日期', field: 'lastUpkeepDate' },
  {
    title: '操作',
    field: 'operation',
    slots: { default: 'action' },
...
export const targetFormSchema: FormSchema[] = [
  {
    field: 'targetId',
    label: '资产编码',
    ...
    componentProps: ({ formActionType }) => {
      return {
        multiple: false,
        onSelect: (targetId: string, rows: Recordable) => {
          const { setFieldsValue } = formActionType;
          setFieldsValue({
...
export const detailByCategoryFormSchema: FormSchema[] = [
  {
    ...
    componentProps: () => {
      return {
        url: '/erp/equipment/upkeep/category/page',
