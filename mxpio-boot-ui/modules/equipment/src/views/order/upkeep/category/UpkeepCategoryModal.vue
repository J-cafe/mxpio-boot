...
<script lang="ts" setup>
  ...
  import { addEqpUpkeepCategoryApi, editEqpUpkeepCategoryApi } from '@mxpio/bizcommon';
  ...
  defineOptions({ name: 'UpkeepCategoryModal' });
      ...
      rules: [
        {
          ...
          validator: async (rule, value) => {
            ...
            return duplicateCheck({
              tableName: 'mb_erp_equipment_upkeep_category',
              column: 'code_',
              key: value,
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit, isUpdate } =
    useModalFormCrud({
      title: '保养方案',
      formSchema,
      addApi: addEqpUpkeepCategoryApi,
      editApi: editEqpUpkeepCategoryApi,
      submitAfter: () => {
