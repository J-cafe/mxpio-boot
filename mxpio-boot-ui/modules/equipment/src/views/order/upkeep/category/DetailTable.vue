...
<script lang="ts" setup>
  ...
  import { detailColumns } from './upkeepCategory.data';
  import {
    eqpUpkeepCategoryDetailPageApi,
    deleteEqpUpkeepCategoryDetailApi,
  ...
  const {
    ...
    pageApi: eqpUpkeepCategoryDetailPageApi,
    deleteApi: deleteEqpUpkeepCategoryDetailApi,
    vxeGridOptions: {
