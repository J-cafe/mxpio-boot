...
<script lang="ts" setup>
  ...
  import { positiveNumberPattern, assistSaveOtherRepairApi } from '@mxpio/bizcommon';
  import { setDataCrud, dateUtil } from '@mxpio/utils';
  import XEUtils from 'xe-utils';

  defineOptions({ name: 'OtherRepairAssistModal' });
  ...
  async function handleSubmit() {
    try {
      ...
      await assistSaveOtherRepairApi(submitData);
      closeModal();
      emit('success');
    } finally {
      setModalProps({ confirmLoading: false });
