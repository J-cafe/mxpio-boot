...
<script lang="ts" setup>
  ...
  import {
    ...
    pickingOtherRepairApi,
    useExecuteClassifyData,
  } from '@mxpio/bizcommon';

  defineOptions({ name: 'OtherRepairPickingModal' });
  ...
  async function handleSubmit() {
    try {
      ...
      await pickingOtherRepairApi(bizNo.value, { lines: submitData });
      closeModal();
      emit('success');
    } finally {
      setModalProps({ confirmLoading: false });
