...
<script lang="ts" setup>
  ...
  import { progressColumns } from './execute.data';
  import { progressOtherRepairPageApi } from '@mxpio/bizcommon';
  import { useListCrudHook } from '@mxpio/common';
  import { useDebounceFn } from '@vueuse/core';

  const componentName = 'ProgressTable';
  ...
  const { tableRef, gridOptions } = useListCrudHook({
    ...
    pageApi: progressOtherRepairPageApi,
    vxeGridOptions: {
