...
<script lang="ts" setup>
  ...
  import {
    otherOutsourceInquiryPageApi,
    deleteOtherOutsourceInquiryApi,
    otherOutsourceInquiryAdoptApi,
  } from '@mxpio/bizcommon';
  import { useListCrudHook } from '@mxpio/common';
  import { useDebounceFn } from '@vueuse/core';
  import OtherRepairInquiryModal from './OtherRepairInquiryModal.vue';
  ...
  const {
    ...
    pageApi: otherOutsourceInquiryPageApi,
    deleteApi: deleteOtherOutsourceInquiryApi,
    vxeGridOptions: {
  ...
  async function handleConfirm(row: Recordable) {
    try {
      await otherOutsourceInquiryAdoptApi(row);
      handleSuccess();
      emit('ok');
    } catch (error) {
