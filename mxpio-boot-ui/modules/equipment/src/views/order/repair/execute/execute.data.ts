...
export const columns: VxeGridPropTypes.Columns = [
  ...
  { title: '资产编码', field: 'targetId', width: 150, slots: { default: 'detail' } },
  ...
  { title: '计划工时(H)', field: 'hourRation', width: 100 },
  {
    title: '维修时长',
    field: 'workMinutes',
    width: 150,
  ...
  { title: '申请时间', field: 'applyTime', width: 150 },
...
export const updateFormSchema: FormSchema[] = [
  {
    ...
    required: true,
    componentProps: {
      dictCode: 'ERP_EQUIPMENT_REPAIR_ORDER_STATUS',
    },
    colProps: {
      span: 24,
    },
