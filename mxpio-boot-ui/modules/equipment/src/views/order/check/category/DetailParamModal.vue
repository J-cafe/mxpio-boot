<template>
  <BasicModal width="900px" title="选项" v-bind="$attrs" destroyOnClose @register="registerModal">
...
<script lang="ts" setup>
  ...
  import { eqpCheckCategoryDetailParamPageApi } from '@mxpio/bizcommon';
  ...
  const { tableRef, gridOptions } = useListCrudHook({
    ...
    columns,
    pageApi: eqpCheckCategoryDetailParamPageApi,
    vxeGridOptions: {
      id: 'DetailParamTable',
      height: 350,
