...
<script lang="ts" setup>
  ...
  import { addEqpCheckPlanDetailApi, editEqpCheckPlanDetailApi } from '@mxpio/bizcommon';
  import { useModalFormCrud } from '@mxpio/common';
  import { detailFormSchema } from './eqpCheckPlan.data';
  import { ref } from 'vue';
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit, setFieldsValue } =
    useModalFormCrud({
      ...
      addApi: addEqpCheckPlanDetailApi,
      editApi: editEqpCheckPlanDetailApi,
      submitAfter: () => {
