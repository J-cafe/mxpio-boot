...
<script lang="ts" setup>
  ...
  import { addEqpInfoAttrApi, editEqpInfoAttrApi } from '@mxpio/bizcommon';
  import { useModalFormCrud } from '@mxpio/common';
  import { attrFormSchema } from './eqpInfo.data';
  import { ref } from 'vue';
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit } = useModalFormCrud({
    ...
    addApi: addEqpInfoAttrApi,
    editApi: editEqpInfoAttrApi,
    submitAfter: () => {
