...
<script lang="ts" setup>
  ...
  import { mnLineListApi, positiveNumberPattern, useMaterialLotSelect } from '@mxpio/bizcommon';

  defineOptions({ name: 'ManufactureOrderInDetailTable' });
  ...
  async function setData(data: Recordable) {
    ...
    const res = await mnLineListApi(record.noticeNo);
