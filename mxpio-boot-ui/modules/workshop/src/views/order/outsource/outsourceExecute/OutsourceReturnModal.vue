...
<script lang="ts" setup>
  ...
  import { returnColumns, bomFormSchema } from './outsourceExecute.data';
  ...
  const componentName = 'OutsourceReturnModal';
  ...
  async function handleSubmit() {
    try {
      ...
      await outsourcePickingApi('18', bizNo.value, executeData);
      closeModal();
      emit('success');
    } finally {
      setModalProps({ confirmLoading: false });
