package com.mxpioframework.excel.export.excel.style;
...
public class GridStyleBuilder extends AbstractStyleBuilder {
	...
	public Map<String, CellStyle> builderGridStyles(Workbook wb, ReportGrid gridModel) {
		...
		if (wb instanceof HSSFWorkbook) {
			return this.createHSSFCellStyles(wb, contextBgColor, contextFontColor, contextFontSize, contextFontAlign,
					headerBgColor, headerFontColor, headerFontSize, headerAlign);
		} else if (wb instanceof SXSSFWorkbook) {
			return this.createXSSFCellStyles(wb, contextBgColor, contextFontColor, contextFontSize, contextFontAlign,
					headerBgColor, headerFontColor, headerFontSize, headerAlign);
		}
		return styles;
	}

	private Map<String, CellStyle> createHSSFCellStyles(Workbook wb, int[] contextBgColor, int[] contextFontColor,
			int contextFontSize, int contextFontAlign, int[] headerBgColor, int[] headerFontColor, int headerFontSize,
			int headerAlign) {
		Map<String, CellStyle> styles = new HashMap<String, CellStyle>();
	...
	private Map<String, CellStyle> createXSSFCellStyles(Workbook wb, int[] contextBgColor, int[] contextFontColor,
		...
		XSSFColor xssfContextBgColor = new XSSFColor(
				new java.awt.Color(contextBgColor[0], contextBgColor[1], contextBgColor[2]), null);
		XSSFColor xssfContextFontColor = new XSSFColor(
				new java.awt.Color(contextFontColor[0], contextFontColor[1], contextFontColor[2]), null);
		XSSFColor xssfHeaderBgColor = new XSSFColor(
				new java.awt.Color(headerBgColor[0], headerBgColor[1], headerBgColor[2]), null);
		XSSFColor xssfHeaderFontColor = new XSSFColor(
				new java.awt.Color(headerFontColor[0], headerFontColor[1], headerFontColor[2]), null);
