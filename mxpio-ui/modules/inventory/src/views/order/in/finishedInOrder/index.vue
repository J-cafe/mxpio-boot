<template>
  <div class="m-3">
    ...
    <FinishedInOrderModal @register="registerModal" @success="handleSuccess" />
...
<script lang="ts" setup>
  ...
  import { columns, searchFormSchema } from './finishedInOrder.data';
  import FinishedInOrderModal from './FinishedInOrderModal.vue';
  import ExpandTable from './ExpandTable.vue';
  import ExecuteModal from './ExecuteModal.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = 'FinishedInOrderList';
