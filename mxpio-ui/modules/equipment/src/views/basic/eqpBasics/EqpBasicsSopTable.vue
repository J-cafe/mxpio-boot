...
<script lang="ts" setup>
  ...
  import { sopColumns } from './eqpBasics.data';
  import { eqpSopPageApi, deleteEqpSopApi } from '@mxpio/bizcommon';
  import { useListCrudHook } from '@mxpio/common';
  import { useCommon } from '@mxpio/hooks';
  import { useDebounceFn } from '@vueuse/core';
  import EqpBasicsSopModal from './EqpBasicsSopModal.vue';

  const componentName = 'EqpBasicsSopTable';
  ...
  const {
    ...
    componentName,
    columns: sopColumns,
    pageApi: eqpSopPageApi,
    deleteApi: deleteEqpSopApi,
    vxeGridOptions: {
