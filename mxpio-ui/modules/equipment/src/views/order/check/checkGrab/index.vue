...
<script lang="ts" setup>
  ...
  import { eqpCheckTaskPageApi, grabEqpCheckTaskApi } from '@mxpio/bizcommon';
  import { useListCrudHook } from '@mxpio/common';
  import { columns, searchFormSchema } from './checkGrab.data';
  ...
  const componentName = 'EqpCheckTaskGrabList';
  ...
  const handleGrab = async (row) => {
    try {
      await grabEqpCheckTaskApi(row.bizNo);
