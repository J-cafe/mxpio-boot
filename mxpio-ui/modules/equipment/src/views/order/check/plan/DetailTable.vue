...
<script lang="ts" setup>
  ...
  import { detailColumns } from './eqpCheckPlan.data';
  import { eqpCheckPlanDetailPageApi, deleteEqpCheckPlanDetailApi } from '@mxpio/bizcommon';
  ...
  const {
    ...
    pageApi: eqpCheckPlanDetailPageApi,
    deleteApi: deleteEqpCheckPlanDetailApi,
    vxeGridOptions: {
