...
<script lang="ts" setup>
  ...
  import { addEqpCheckPlanTargetByCategoryApi } from '@mxpio/bizcommon';
  import { useModalFormCrud } from '@mxpio/common';
  import { targetByCategoryFormSchema } from './eqpCheckPlan.data';
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit } = useModalFormCrud({
    ...
    addApi: addEqpCheckPlanTargetByCategoryApi,
    submitAfter: () => {
