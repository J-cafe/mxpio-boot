...
<script lang="ts" setup>
  ...
  import { eqpCheckTaskDetailListApi, eqpCheckTaskDetailParamListApi } from '@mxpio/bizcommon';
  import { executeDetailColumns } from './eqpCheckExecute.data';
  import { useCommon } from '@mxpio/hooks';
  import { getVxeTableQueryParams } from '@mxpio/utils';

  defineOptions({ name: 'EqpCheckExecuteDetailTable' });
  ...
  async function loadData() {
    ...
    const res = await eqpCheckTaskDetailListApi(params);
  ...
  async function listDetailParams(id: string) {
    ...
    try {
      const res = await eqpCheckTaskDetailParamListApi(id);
