...
<script lang="ts" setup>
  ...
  import { assistOtherRepairPageApi, assistDeleteOtherRepairApi } from '@mxpio/bizcommon';
  ...
  const { tableRef, gridOptions, handleDelete } = useListCrudHook({
    componentName,
    columns: assistColumns,
    pageApi: assistOtherRepairPageApi,
    deleteApi: assistDeleteOtherRepairApi,
    vxeGridOptions: {
