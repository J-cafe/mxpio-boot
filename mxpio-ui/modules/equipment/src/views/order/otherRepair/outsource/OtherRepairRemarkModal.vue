...
<script lang="ts" setup>
  ...
  import { addOtherOutsourceRemarkApi, editOtherOutsourceRemarkApi } from '@mxpio/bizcommon';
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit } = useModalFormCrud({
    ...
    addApi: addOtherOutsourceRemarkApi,
    editApi: editOtherOutsourceRemarkApi,
    submitAfter: () => {
