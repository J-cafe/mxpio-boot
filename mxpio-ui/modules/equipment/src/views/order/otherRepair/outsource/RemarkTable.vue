...
<script lang="ts" setup>
  ...
  import { otherOutsourceRemarkPageApi, deleteOtherOutsourceRemarkApi } from '@mxpio/bizcommon';
  import { useListCrudHook } from '@mxpio/common';
  import { useDebounceFn } from '@vueuse/core';
  import OtherRepairRemarkModal from './OtherRepairRemarkModal.vue';
  ...
  const {
    ...
    pageApi: otherOutsourceRemarkPageApi,
    deleteApi: deleteOtherOutsourceRemarkApi,
    vxeGridOptions: {
