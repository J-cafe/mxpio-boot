...
<script lang="ts" setup>
  ...
  import { repairOutsourceRemarkPageApi, deleteRepairOutsourceRemarkApi } from '@mxpio/bizcommon';
  ...
  const {
    ...
    pageApi: repairOutsourceRemarkPageApi,
    deleteApi: deleteRepairOutsourceRemarkApi,
    vxeGridOptions: {
