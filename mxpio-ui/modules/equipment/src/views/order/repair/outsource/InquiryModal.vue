...
<script lang="ts" setup>
  ...
  import { editRepairOutsourceInquiryApi, addRepairOutsourceInquiryApi } from '@mxpio/bizcommon';
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit, isUpdate } =
    useModalFormCrud({
      ...
      addApi: addRepairOutsourceInquiryApi,
      editApi: editRepairOutsourceInquiryApi,
      submitAfter: () => {
