...
<script lang="ts" setup>
  ...
  import { eqpRepairRemarkPageApi, deleteEqpRepairRemarkApi } from '@mxpio/bizcommon';
  import { useListCrudHook } from '@mxpio/common';
  import { useDebounceFn } from '@vueuse/core';
  import EqpBasicsRemarkModal from './RemarkModal.vue';

  const componentName = 'EqpRepairRemarkTable';
  ...
  const {
    ...
    pageApi: eqpRepairRemarkPageApi,
    deleteApi: deleteEqpRepairRemarkApi,
    vxeGridOptions: {
