...
<script lang="ts" setup>
  ...
  import { resendEqpRepairApi } from '@mxpio/bizcommon';
  import { ref } from 'vue';

  defineOptions({ name: 'EqpRepairResendModal' });
  ...
  async function handleSubmit() {
    try {
      ...
      await resendEqpRepairApi({
        bizNo: bizNo.value,
        distributePersonId: values.distributePersonId,
