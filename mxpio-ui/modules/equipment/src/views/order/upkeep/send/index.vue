<template>
  <div class="m-3">
    ...
    <EqpUpkeepTaskSendModal width="600px" @register="registerSendModal" @success="handleSuccess" />
  </div>
</template>
<script lang="ts" setup>
  import { TableAction, VxeBasicTable, useModal } from '@mxpio/components';
  import { eqpUpkeepTaskPageApi } from '@mxpio/bizcommon';
  ...
  import EqpUpkeepTaskSendModal from './EqpUpkeepTaskSendModal.vue';
  import { useMessage } from '@mxpio/hooks';

  const componentName = 'EqpUpkeepTaskSendList';
