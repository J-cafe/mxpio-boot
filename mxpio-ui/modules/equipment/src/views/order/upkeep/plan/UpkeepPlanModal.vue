...
<script lang="ts" setup>
  ...
  import { addEqpUpkeepPlanApi, editEqpUpkeepPlanApi } from '@mxpio/bizcommon';
  import { useModalFormCrud } from '@mxpio/common';
  import type { FormSchema } from '@mxpio/components';
  import { dateUtil } from '@mxpio/utils';

  defineOptions({ name: 'UpkeepPlanModal' });
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit } = useModalFormCrud({
    title: '保养计划',
    formSchema,
    addApi: addEqpUpkeepPlanApi,
    editApi: editEqpUpkeepPlanApi,
    submitAfter: () => {
