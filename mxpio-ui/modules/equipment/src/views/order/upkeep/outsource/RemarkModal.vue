...
<script lang="ts" setup>
  ...
  import { addUpkeepOutsourceRemarkApi, editUpkeepOutsourceRemarkApi } from '@mxpio/bizcommon';
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit } = useModalFormCrud({
    ...
    addApi: addUpkeepOutsourceRemarkApi,
    editApi: editUpkeepOutsourceRemarkApi,
    submitAfter: () => {
