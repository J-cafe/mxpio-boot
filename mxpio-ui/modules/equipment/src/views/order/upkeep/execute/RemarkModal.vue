...
<script lang="ts" setup>
  ...
  import { addEqpUpkeepRemarkApi, editEqpUpkeepRemarkApi } from '@mxpio/bizcommon';
  import { useModalFormCrud } from '@mxpio/common';
  import { remarkFormSchema } from './execute.data';
  import { ref } from 'vue';

  defineOptions({ name: 'EqpUpkeepRemarkModal' });
  ...
  const { registerForm, registerModal, getTitle, isDisabled, handleSubmit } = useModalFormCrud({
    ...
    addApi: addEqpUpkeepRemarkApi,
    editApi: editEqpUpkeepRemarkApi,
    submitAfter: () => {
