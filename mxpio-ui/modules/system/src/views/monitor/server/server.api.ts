...
export const getCpuCount = () => {
  ...
  return http.get({ url: Api.cpuCount }, { isTransformResponse: false });
};
...
export const getCpuUsage = () => {
  const { http } = useBridge();
  return http.get({ url: Api.cpuUsage }, { isTransformResponse: false });
};
...
export const getProcessStartTime = () => {
  const { http } = useBridge();
  return http.get({ url: Api.processStartTime }, { isTransformResponse: false });
};
...
export const getProcessUptime = () => {
  const { http } = useBridge();
  return http.get({ url: Api.processUptime }, { isTransformResponse: false });
};
...
export const getProcessCpuUsage = () => {
  const { http } = useBridge();
  return http.get({ url: Api.processCpuUsage }, { isTransformResponse: false });
};
...
export const getJvmMemoryMax = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmMemoryMax }, { isTransformResponse: false });
};
...
export const getJvmMemoryCommitted = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmMemoryCommitted }, { isTransformResponse: false });
};
...
export const getJvmMemoryUsed = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmMemoryUsed }, { isTransformResponse: false });
};
...
export const getJvmBufferMemoryUsed = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmBufferMemoryUsed }, { isTransformResponse: false });
};
...
export const getJvmBufferCount = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmBufferCount }, { isTransformResponse: false });
};
...
export const getJvmThreadsDaemon = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmThreadsDaemon }, { isTransformResponse: false });
};
...
export const getJvmThreadsLive = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmThreadsLive }, { isTransformResponse: false });
};
...
export const getJvmThreadsPeak = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmThreadsPeak }, { isTransformResponse: false });
};
...
export const getJvmClassesLoaded = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmClassesLoaded }, { isTransformResponse: false });
};
...
export const getJvmClassesUnloaded = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmClassesUnloaded }, { isTransformResponse: false });
};
...
export const getJvmGcMemoryAllocated = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmGcMemoryAllocated }, { isTransformResponse: false });
};
...
export const getJvmGcMemoryPromoted = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmGcMemoryPromoted }, { isTransformResponse: false });
};
...
export const getJvmGcMaxDataSize = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmGcMaxDataSize }, { isTransformResponse: false });
};
...
export const getJvmGcLiveDataSize = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmGcLiveDataSize }, { isTransformResponse: false });
};
...
export const getJvmGcPause = () => {
  const { http } = useBridge();
  return http.get({ url: Api.jvmGcPause }, { isTransformResponse: false });
};
...
export const getTomcatSessionsCreated = () => {
  const { http } = useBridge();
  return http.get({ url: Api.tomcatSessionsCreated }, { isTransformResponse: false });
};
...
export const getTomcatSessionsExpired = () => {
  const { http } = useBridge();
  return http.get({ url: Api.tomcatSessionsExpired }, { isTransformResponse: false });
};
...
export const getTomcatSessionsActiveCurrent = () => {
  const { http } = useBridge();
  return http.get({ url: Api.tomcatSessionsActiveCurrent }, { isTransformResponse: false });
};
...
export const getTomcatSessionsActiveMax = () => {
  const { http } = useBridge();
  return http.get({ url: Api.tomcatSessionsActiveMax }, { isTransformResponse: false });
};
...
export const getTomcatSessionsRejected = () => {
  const { http } = useBridge();
  return http.get({ url: Api.tomcatSessionsRejected }, { isTransformResponse: false });
};
