<template>
  ...
  >
    ...
    <a-tabs v-if="formDataRef.itemType === '2' || formDataRef.itemType === 2">
      <a-tab-pane key="detailTable" tab="选项" forceRender>
...
<script lang="ts" setup>
  ...
  import { saveIiApi } from '@mxpio/bizcommon';
  import { useModalFormCrud } from '@mxpio/common';
  import { formSchema } from './item.data';
  import DetailTable from './DetailTable.vue';
  import { ref } from 'vue';

  defineOptions({ name: 'QualityItemModal' });
