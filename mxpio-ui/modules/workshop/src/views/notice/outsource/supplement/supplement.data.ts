...
export const columns: VxeGridPropTypes.Columns = [
  ...
  { title: '通知单号', field: 'noticeNo', width: 100 },
  { title: '委外订单号', field: 'bizOrderNo', width: 100 },
  { title: '单据状态', field: 'noticeStatus', formatter: 'dictText', width: 100 },
  ...
  { title: '仓库编码', field: 'whCode', formatter: 'dictText', width: 100 },
...
export const executeColumns: VxeGridPropTypes.Columns = [
  ...
  { title: '补料原因', field: 'supplementReason', width: 80 },
  {
    title: '批次号',
    field: 'lotNo',
    width: 120,
