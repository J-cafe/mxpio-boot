...
<script lang="ts" setup>
  ...
  import { oomnLineListApi, positiveNumberPattern, useMaterialLotSelect } from '@mxpio/bizcommon';

  defineOptions({ name: 'OutsourceOrderInDetailTable' });
  ...
  async function setData(data: Recordable) {
    ...
    const res = await oomnLineListApi(record.noticeNo);
