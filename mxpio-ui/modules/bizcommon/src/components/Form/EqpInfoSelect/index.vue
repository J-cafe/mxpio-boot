<template>
  <div>
    ...
    />
    <EqpInfoModal v-bind="$attrs" @register="registerModal" @success="handleSuccess" />
  </div>
</template>

<script lang="ts" setup>
  import { useModal } from '@mxpio/components';
  import EqpInfoModal from './EqpInfoModal.vue';

  defineOptions({ name: 'EqpInfoSelect' });
  ...
  defineProps({
    ...
    placeholder: { type: String, default: '选择设备信息' },
  });
