...
import { BasicDrawer, AppDarkModeToggle } from '@mxpio/components';
...
import { MenuTypeEnum, TriggerEnum } from '@mxpio/enums/src/menuEnum';
...
// } from '@mxpio/settings/src/designSetting';
// import { SIDE_BAR_BG_COLOR_LIST } from '@mxpio/settings/src/designSetting';
...
export default defineComponent({
  ...
  setup(_, { attrs }) {
    ...
    function renderSideBarTheme() {
      return (
        <ThemeColorPicker
          colorList={designSetting.SIDE_BAR_BG_COLOR_LIST}
