...
<script lang="ts" setup>
  ...
  import { Icon, getMenus } from '@mxpio/components';
  ...
  import { filter } from '@mxpio/utils/src/helper/treeHelper';
  ...
  watchEffect(async () => {
    if (currentRoute.value.name === RouterEnum.REDIRECT_NAME) return;
  ...
  function handleClick(route, paths: string[], e: Event) {
    e?.preventDefault();
