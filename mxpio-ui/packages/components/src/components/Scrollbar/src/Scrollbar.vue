...
<script lang="ts" setup>
  ...
  import type { StyleValue } from '@mxpio/utils/src/types';
  import { addResizeListener, removeResizeListener } from '@mxpio/utils/src/event';
  ...
  const props = defineProps({
    native: {
      ...
      default: () => {
        ...
        return componentSetting.scrollbar?.native ?? false;
      },
    },
    wrapStyle: {
