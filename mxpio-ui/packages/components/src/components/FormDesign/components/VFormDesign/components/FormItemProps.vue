  ...
  <div class="properties-content">
    <div class="properties-body" v-if="formConfig.currentItem?.itemProps">
      ...
      <Form v-else label-align="left" layout="vertical">
        <div v-for="item of dynamicBaseFormItemProps" :key="item.name">
...
<script lang="ts" setup name="FormItemProps">
  ...
  const dynamicBaseFormItemProps = computed(() => {
    return baseFormItemProps.map((prop) => {
        ...
        return {
          ...
          componentProps: {
            ...
            options: baseComponents
              .concat(formDesignComponents.customComponents)
