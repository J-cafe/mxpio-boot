<script lang="tsx">
  ...
  import clickOutside from '@mxpio/directives/src/clickOutside';

  import { propTypes } from '@mxpio/utils/src/propTypes';
  import { isArray, isBoolean, isFunction, isNumber, isString } from '@mxpio/utils/src/is';
  import { createPlaceholderMessage } from './helper';
  import { pick, set } from 'lodash-es';
  import { treeToList } from '@mxpio/utils/src/helper/treeHelper';
