...
interface _CustomComponents {
  ...
  StrengthMeter: ExtractPropTypes<
    (typeof import('../../../StrengthMeter/src/StrengthMeter.vue'))['default']
  >;
  Upload: ExtractPropTypes<(typeof import('../../../Upload/src/BasicUpload.vue'))['default']>;
  ImageUpload: ExtractPropTypes<
    (typeof import('../../../Upload/src/components/ImageUpload.vue'))['default']
  >;
  IconPicker: ExtractPropTypes<(typeof import('../../../Icon/src/IconPicker.vue'))['default']>;
  ApiTransfer: ExtractPropTypes<(typeof import('../components/ApiTransfer.vue'))['default']>;
  CropperAvatar: ExtractPropTypes<
    (typeof import('../../../Cropper/src/CropperAvatar.vue'))['default']
  >;
  BasicTitle: ExtractPropTypes<(typeof import('../../../Basic/src/BasicTitle.vue'))['default']>;
  InputCountDown: ExtractPropTypes<
    (typeof import('../../../CountDown/src/CountdownInput.vue'))['default']
  >;
  EasyCron: ExtractPropTypes<
    (typeof import('../components/EasyCron/EasyCronInput.vue'))['default']
  >;
  ApiSelectPage: ExtractPropTypes<
    (typeof import('../components/ApiSelectPage/index.vue'))['default']
  >;
  BizSelect: ExtractPropTypes<(typeof import('../components/BizSelect/index.vue'))['default']>;
}
...
export interface ComponentProps {
  ...
  EasyCron: CustomComponents['EasyCron'];
  ApiSelectPage: CustomComponents['ApiSelectPage'];
  BizSelect: CustomComponents['BizSelect'];
}
