...
// componentMap.set(
//   'DeptSelect',
//   createAsyncComponent(() => import('./components/DeptSelect/index.vue')),
// );
// componentMap.set(
//   'UserByDeptSelect',
//   createAsyncComponent(() => import('./components/UserByDeptSelect/index.vue')),
// );

componentMap.set(
  'ApiSelectPage',
  createAsyncComponent(() => import('./components/ApiSelectPage/index.vue')),
);
...
componentMap.set(
  'BizSelect',
  createAsyncComponent(() => import('./components/BizSelect/index.vue')),
);
