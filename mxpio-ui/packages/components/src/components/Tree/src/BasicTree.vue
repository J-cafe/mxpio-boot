<script lang="tsx">
  ...
  import { isArray, isBoolean, isEmpty, isFunction } from '@mxpio/utils/src/is';
  import { extendSlots, getSlot } from '@mxpio/utils/src/helper/tsxHelper';
  import { filter, treeToList, eachTree } from '@mxpio/utils/src/helper/treeHelper';
  import { useTree } from './hooks/useTree'; ///web/useContextMenu
  import { useContextMenu } from '../../ContextMenu/src/useContextMenu';
  import { CreateContextOptions } from '../../ContextMenu';
  import { treeEmits, treeProps } from './types/tree';
  import { createBEM } from '@mxpio/utils/src/bem';
