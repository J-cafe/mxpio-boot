...
package com.mxpioframework.msal.utils;
...
public class AuthHelper {
    ...
    private void validateAuthRespMatchesAuthCodeFlow(AuthenticationSuccessResponse oidcResponse) throws Exception {
        if (oidcResponse.getIDToken() != null || oidcResponse.getAccessToken() != null ||
            ...
            throw new Exception( "unexpected set of artifacts received");
        }
    }
    ...
    public String getSendAuthRedirectUrl(String redirectURL) throws MalformedURLException {
        String state = UUID.randomUUID().toString();
        String nonce = UUID.randomUUID().toString();
        return getAuthorizationCodeUrl(null, null, redirectURL, state, nonce);
    }
    ...
    public ConfidentialClientApplication createClientApplication() throws MalformedURLException {
